...
class Classifier_Train: IDisposable
{
    ...
    {
        _IsTrained = LoadTrainingData(System.AppDomain.CurrentDomain.BaseDirectory + @"FaceTrained\TrainData");
    }
    ...
    public bool Retrain()
    {
        return _IsTrained = LoadTrainingData(System.AppDomain.CurrentDomain.BaseDirectory + @"FaceTrained\TrainData");
    }
    /// <summary>
    /// Retrains the recognizer witout resetting variables like recognizer type.
    /// Takes String input to a different location for training data.
